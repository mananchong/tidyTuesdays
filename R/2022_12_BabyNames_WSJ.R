...
df_names_div_std <- df_names_div_sex_letter %>%
  bind_rows(df_names_div_sex %>%
    mutate(first_letter = "\u2211") %>%
  ...
  mutate(
    ...
    sex = ifelse(sex == "F",
      "<span style='color:#E29421;'>Female Babies</span>",
...
plot_names_div_blank <-
  ...
  scale_color_gradientn(
    colors = rev(cols),
    limits = range(df_names_div_std$shannon_std),
    guide = "none"
  ) +
  scale_fill_gradientn(
    colors = rev(cols),
    name = "<b>Diversity of Names</b><br><i style='font-size:18pt;'>standardized per first letter across sexes</i>",
    breaks = seq(min(df_names_div_std$shannon_std),
      max(df_names_div_std$shannon_std),
      length.out = 7
    ),
    labels = c(
      "<b style='font-size:20pt;color:#212121;'>Low</b><br>One name is<br>dominating",
      "",
      "",
      "<b style='font-size:20pt;color:#212121;'>Medium</b>",
      "",
      "",
      "<b style='font-size:20pt;color:#212121;'>High</b><br>Many names of<br>similar frequency"
    )
  ) +
  labs(x = NULL, y = NULL) +
...
ggsave(here::here(
  ...
  "2022_12",
  "WSJ_edition",
  "2022_12_Babynames_Diversity_WSJ_blank.pdf"
),
width = 31,
height = 18,
device = cairo_pdf
...
plot_names_div_olivia <-
  ...
  geom_text(
    ...
    aes(
      label = label,
      color = stage(shannon_std,
        after_scale = darken(color, .5)
      )
    ),
    family = "Sentient-BoldItalic",
    size = 5.2
...
ggsave(here::here(
  ...
  "2022_12",
  "WSJ_edition",
  "2022_12_Babynames_Diversity_WSJ_olivia.pdf"
),
width = 31,
height = 18,
device = cairo_pdf
...
ggsave(here::here(
  ...
  "2022_12",
  "WSJ_edition",
  "2022_12_Babynames_Diversity_WSJ_labs.pdf"
),
width = 31,
height = 18,
device = cairo_pdf
...
plot_names_div_period <- plot_names_div_blank +
  geom_vline(
    xintercept = c(1930, 1990, 2000),
    size = .6,
    linetype = "13"
  ) +
  geom_text(
...
ggsave(here::here(
  ...
  "2022_12",
  "WSJ_edition",
  "2022_12_Babynames_Diversity_WSJ_period.pdf"
),
width = 31,
height = 18,
device = cairo_pdf
...
ggsave(here::here(
  ...
  "2022_12",
  "WSJ_edition",
  "2022_12_Babynames_Diversity_WSJ_all.pdf"
),
width = 31,
height = 18,
device = cairo_pdf
...
ggsave(here::here(
  ...
  "WSJ_edition",
  "long_version",
  "2022_12_Babynames_Diversity_WSJ_blank_long.pdf"
),
width = 18,
height = 31,
device = cairo_pdf
...
ggsave(here::here(
  ...
  "WSJ_edition",
  "long_version",
  "2022_12_Babynames_Diversity_WSJ_olivia_long.pdf"
),
width = 18,
height = 31,
device = cairo_pdf
...
ggsave(here::here(
  ...
  "WSJ_edition",
  "long_version",
  "2022_12_Babynames_Diversity_WSJ_labs_long.pdf"
),
width = 18,
height = 31,
device = cairo_pdf
...
ggsave(here::here(
  ...
  "WSJ_edition",
  "long_version",
  "2022_12_Babynames_Diversity_WSJ_period_long.pdf"
),
width = 18,
height = 31,
device = cairo_pdf
...
ggsave(here::here(
  ...
  "WSJ_edition",
  "long_version",
  "2022_12_Babynames_Diversity_WSJ_all_long.pdf"
),
width = 18,
height = 31,
device = cairo_pdf
